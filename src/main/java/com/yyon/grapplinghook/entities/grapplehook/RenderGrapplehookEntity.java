...
//    }
    ...
    // draw a segment of the rope (shared with the lead overhaul)
    public void drawSegment(Vec start, Vec finish, double taut, VertexConsumer vertexbuffer, Matrix4f matrix, Matrix3f matrix3, int p_225623_6_) {
        com.yyon.grapplinghook.client.RopeRenderer.drawSegment(start, finish, taut, vertexbuffer, matrix, matrix3, p_225623_6_);
    }
